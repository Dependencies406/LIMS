      ...
      {attachments.length === 0 ? (
        ...
        <div className="space-y-2">
          {attachments.map((attachment) => {
            const fileInfo = getFileTypeInfo(attachment.fileType ?? attachment.type ?? '');
                ...
                <div className="flex items-center space-x-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2">
                      <p className="text-sm font-medium text-gray-900 truncate" title={attachment.fileName ?? attachment.name}>
                        {attachment.fileName ?? attachment.name}
                      </p>
                      <span className="text-xs text-gray-500 flex-shrink-0">
                        {formatFileSize(attachment.fileSize ?? attachment.size ?? 0)}
                      </span>
                    </div>
