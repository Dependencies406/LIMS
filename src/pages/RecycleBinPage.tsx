...
export const RecycleBinPage: React.FC = () => {
  ...
  const { hasPermission: canViewDeleted, loading: permLoading } = usePermission('jobs.viewDeleted');
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-16">
            ...
            <p className="text-sm text-gray-500">You don't have permission to view the recycle bin.</p>
          </div>
        </div>
      </div>
    );
